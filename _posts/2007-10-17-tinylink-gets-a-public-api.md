...
toc: false
classes: wide
excerpt: After a lengthy discussion with Charl last night I got some inspiration and created a Public API for TinyLink. The API can be used through a REST or JSON request and if you're a developer you can chose either to integrate into your application.
