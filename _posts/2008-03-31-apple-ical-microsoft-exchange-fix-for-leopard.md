...
toc: false
classes: wide
excerpt: One of the major drawbacks to working on an Apple Mac in a large corporate company is that most IT departments still use Microsoft Exchange Server for email and calendar support.
header:
  overlay_image: '/assets/images/uploads/2008/03/ical-mailrules.jpg'
  overlay_filter: rgba(0, 0, 0, 0.5)
  teaser: '/assets/images/uploads/2008/03/ical-mailrules.jpg'
...
- id: 1539
  ...
  content: "Dr. Strangeluv - I've tried this before to no avail. In fact trying to
    ...
    the data is safe from corruption.\r\n\r\nAndy - please send it onto me me
    (at) justhart.com - I'd love to see what you've done and test it on my side.
...
- id: 2896
  ...
  content: Hi Guys. I&#39;ve just released version 1.2 of this script. More details
    can be found over here:<br><a href="/2008/08/28/apple-ical-microsoft-exchange-fix-version-12-released/">/2008/08/28/apple-ical-...</a>
- id: 2975
  author: Anna
