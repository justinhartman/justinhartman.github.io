...
wordpress_id: 285
redirect_from: /2008/07/31/how-to-change-vodacom-apn-settings-on-iphone-2-firmware/
author_profile: true
toc: false
classes: wide
excerpt: When I upgraded my iPhone firmware from version 1.1.4 to version 2.0 I realised that I had lost the use of EDGE on the Vodacom network. Justin from WantItAll alerted me to the iPhone Configuration Utility which allows you to create custom profiles for your iPhone.
header:
  overlay_image: '/assets/images/uploads/2008/07/unlock1.png'
  overlay_filter: rgba(0, 0, 0, 0.5)
  teaser: '/assets/images/uploads/2008/07/unlock1.png'
