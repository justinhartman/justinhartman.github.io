...
toc: false
classes: wide
excerpt: I'm a huge fan of Muti which is a superb African Social Bookmark site where users can post links to content on the web. The site, based largely off Reddit, has proven to be a great source of leading content within the African continent and generally what appears on Muti is worth the read.
