...
wordpress_id: 296
redirect_from: /2008/08/28/apple-ical-microsoft-exchange-fix-version-12-released/
author_profile: true
toc: false
classes: wide
excerpt: 'I have updated the Apple iCal / Microsoft Exchange fix for Leopard with a bug fix and a few enhancements. Here are the release notes for this version: Fixed = iCal bug message saying "no data was added to iCal" thanks to Jon Milan. Added = London timezone support thanks to Ryan Hunt.'
header:
  overlay_image: '/assets/images/uploads/2008/03/ical-openwith.png'
  overlay_filter: rgba(0, 0, 0, 0.5)
  teaser: '/assets/images/uploads/2008/03/ical-openwith.png'
