...
toc: false
classes: wide
excerpt: Hidden inside Google Earth is a secret Flight Simulator that takes full advantage of Googleâ€™s extensive satellite imagery. To access the hidden feature, open Google Earth and hit Command+Option+A (note it must be capital A) or Ctrl+Alt+A if youâ€™re using a Windows Machine.
