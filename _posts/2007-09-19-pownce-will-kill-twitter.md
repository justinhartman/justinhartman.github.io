...
toc: false
classes: wide
excerpt: Pownce is similar Twitter, only better. I've been using it now for a couple days and I'm far more impressed with the the user experience and reliability than I am with Twitter. Some experts will swear Jaiku is the one to watch but there are a couple things which make Pownce a winner in my opinion.
header:
  overlay_image: '/assets/images/uploads/2007/09/adobe_air.gif'
  overlay_filter: rgba(0, 0, 0, 0.5)
  teaser: '/assets/images/uploads/2007/09/adobe_air.gif'
...
<!--more-->The site is still in Alpha stages so I'll forgive them for only having a choice of four themes to select from.
